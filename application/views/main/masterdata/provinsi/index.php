...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Master Data Provinsi</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Master Data Provinsi</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <!-- Small boxes (Stat box) -->
              ...
              <div class="card-header">
                <h3 class="card-title">New Provinsi</h3>
              </div>
              ...
              <form action="<?= base_url('master/provinsi/new') ?>" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="provinsi" placeholder="Nama Provinsi" name="provinsi">
                  </div>
                </div>
                <!-- /.card-body -->
										...
										<tbody>
												<?php $no = 1; foreach($provinsi as $row): ?>
														<tr>
																...
																<td><?= $row->provinsi; ?></td>
																<td>
																		<a href="<?= base_url('master/provinsi/delete/'.$row->id_provinsi); ?>" class="btn btn-danger btn-sm">Hapus</a>
																</td>
														</tr>
												<?php endforeach; ?>
										</tbody>
